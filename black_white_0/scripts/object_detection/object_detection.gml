...
var x_dir = lengthdir_x(34,angle);
var y_dir = lengthdir_y(34,angle);
var hit = collision_line(x,y,x+x_dir,y+y_dir,o_interaction_parent,false,true);

//For the VIEWING ROOM
if hit != -4  //if the collision is hitting anything AND you press the ENTER key.
{		
	//Creates text box
